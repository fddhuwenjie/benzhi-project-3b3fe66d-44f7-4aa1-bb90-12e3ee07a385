...
func (s *Store) queueReadTransaction(ctx context.Context) (*sql.Tx, error) {
	s.queueMu.Lock()
	defer s.queueMu.Unlock()
	if s.queueSnapshot != nil {
		return s.queueSnapshot, nil
	}
